...
وصف المشروع:
المشروع هو جزء من مشروع صغير متعدد الوسائط (Mini Project for Multimedia) تم إعداده تحت إشراف الأستاذ الدكتور Baraa Ismael Farhan من قسم علوم الحاسوب في كلية التربية للعلوم الصرفة بجامعة واسط، جمهورية العراق. المشروع يهدف إلى تصميم وتنفيذ نظام مراقبة فيديو يعمل عبر شبكات الاستشعار المتعددة الوسائط اللاسلكية (Wireless Multimedia Sensor Networks - WMSNs).

أهداف المشروع:
تطوير نظام مراقبة فيديو:
توفير حلول فعالة لمراقبة الفيديو باستخدام شبكات الاستشعار اللاسلكية.
تحقيق كفاءة عالية في نقل ومعالجة البيانات المتعددة الوسائط (مثل الفيديو والصوت).
تحسين أداء الشبكة:
ضمان جودة الخدمة (QoS) في نقل بيانات الفيديو عبر شبكات الاستشعار.
تقليل زمن الوصول (Latency) واستهلاك الطاقة.
تكامل مع التقنيات الحديثة:
استخدام تقنيات مثل الذكاء الاصطناعي لاكتشاف الحركة والتعرف على الأشياء.
دعم التحليل في الوقت الفعلي (Real-time Analysis).
تفاصيل المشروع:
1. التقنيات المستخدمة:
Django: لإنشاء الخلفية (Backend) وإدارة قاعدة البيانات.
Flutter: لتطوير واجهة المستخدم الأمامية (Frontend) التي تعمل على الأجهزة المحمولة.
OpenCV / TensorFlow: لتحليل الفيديو واكتشاف الأحداث غير العادية.
Wireless Multimedia Sensor Networks (WMSNs): لتوصيل الكاميرات وأجهزة الاستشعار.
2. الفريق القائم على المشروع:
الإشراف: الأستاذ الدكتور Baraa Ismael Farhan.
الباحثون المشاركون:
Mahmoud Shamran Atheeb
Ali Jabbar Sharhan
Qusay Joudah Shaheen
Azhar Abdalhmeed Jafer
3. النطاق الزمني للمشروع:
المشروع مخطط له ليتم تنفيذه خلال الفترة 2024-2025 .
4. التطبيقات العملية:
الأمن المنزلي: مراقبة المنازل عن بُعد.
المراقبة البيئية: تتبع النشاطات البيئية باستخدام كاميرات الاستشعار.
إدارة المدن الذكية: تعزيز الأمن والمراقبة في المناطق الحضرية.
التحديات والحلول المقترحة:
التحديات:
نقل البيانات: نقل الفيديو عبر شبكات الاستشعار اللاسلكية قد يكون مكلفًا من حيث استهلاك الطاقة وزمن الوصول.
معالجة البيانات: تحليل الفيديو في الوقت الفعلي يتطلب موارد حوسبة كبيرة.
الأمان: حماية البيانات المرسلة عبر الشبكة من الاختراق.
الحلول المقترحة:
ضغط الفيديو: استخدام تقنيات ضغط الفيديو لتقليل حجم البيانات المنقولة.
خوارزميات ذكية: استخدام خوارزميات التعلم الآلي لتحليل الفيديو بكفاءة.
تشفير البيانات: تأمين البيانات باستخدام تقنيات التشفير الحديثة.
أهمية المشروع:
يساهم المشروع في تحسين أنظمة المراقبة باستخدام تقنيات حديثة مثل الذكاء الاصطناعي وشبكات الاستشعار اللاسلكية.
يقدم حلاً عمليًا يمكن تطبيقه في مجالات مختلفة مثل الأمن، البيئة، والمدن الذكية.
يعكس التعاون بين الباحثين العراقيين في تطوير تقنيات جديدة تلبي احتياجات المجتمع.
